...
![DHCP console showing dc01.homelab.ca — right-clicking IPv4 to create new scope](screenshots/8.png)
...
![IP Address Range configured — 192.168.10.100 to 192.168.10.200, subnet /24](screenshots/10.png)
